...
const THEME = {
  dark: {
    frame: '#404040',
    bezel: '#262626',
    dynamicIsland: '#262626',
    dot: '#404040',
  },
  light: {
    frame: '#e5e5e5',
    bezel: '#fff',
    dynamicIsland: '#f5f5f5',
    dot: '#e5e5e5',
  },
} as const;
      ...
      {!(src || videoSrc) && (
        <g clipPath={clipPathRef}>
          <foreignObject
            ...
            y="19.25"
          >
            <div className="size-full bg-preview-placeholder bg-cover bg-center bg-no-repeat" />
          </foreignObject>
        </g>
      )}
